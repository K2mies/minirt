...
/*   Updated: 2025/08/01 16:12:41 by rhvidste         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
#include "minirt.h"

/**
 * @brief	apllys transforms in the correct order as stored in the obj->transforms
 * takes each transform from the obj->transforms array and applys them in order of
...
void	apply_transforms(t_object *obj)
{
	...
	res = multiply_matrix4(res, obj->transforms[translate][xyz]);
